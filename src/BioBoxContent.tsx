  ...
  <BioBox id='about'>
    <div className='biobox-inner'>
      <div className='text-wrapper'>
        ...
        <br />
        I{"'"}m a frontend engineer, coach, and cybersecurity enthusiast based in Los Angeles, CA. Most mornings you can find me at the beach or the gym earlier than most people you know.
        <br /><br />
        I have the CompTIA Security+ ce certification and over 15 years in IT. Additionally, I{"'"}ve led groups and individuals to personal and career success through coaching.
        <br /><br />
