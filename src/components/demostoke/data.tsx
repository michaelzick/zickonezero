...
export const HOW_IMAGES = [
  { src: '/img/demostoke/case-study/ds-blog.webp', alt: 'DemoStoke blog index with search filters and post cards' },
  { src: '/img/demostoke/case-study/ds-blog-post.webp', alt: 'DemoStoke blog article page with a ski brand hero image and body text' },
  { src: '/img/demostoke/case-study/ds-shop-page.webp', alt: 'DemoStoke shop profile page with equipment listings and store details' },
  { src: '/img/demostoke/case-study/ds-gear-page.webp', alt: 'DemoStoke gear detail page with a book now button and similar equipment' },
  { src: '/img/demostoke/case-study/ds-explore-hybrid.webp', alt: 'DemoStoke explore hybrid view with a map and surfboard equipment cards' },
  { src: '/img/demostoke/case-study/ds-calendar-cal.webp', alt: 'DemoStoke demo calendar month view with scheduled events and category filters' },
  { src: '/img/demostoke/case-study/ds-calendar-list.webp', alt: 'DemoStoke demo calendar list view with upcoming events' },
  { src: '/img/demostoke/case-study/ds-gear-quiz.webp', alt: 'DemoStoke gear quiz category selection screen for snowboards, skis, surfboards, and mountain bikes' }
] as const;
