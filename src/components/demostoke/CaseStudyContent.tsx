  ...
  <div id='executive-content'>
    <PageShell>
      <CaseStudyPageInner className='demostoke-inner'>
        <CaseStudyIntroOffset>
          <IntroSection setAnimatedSectionRef={setAnimatedSectionRef} visibleSections={visibleSections} />
        </CaseStudyIntroOffset>
        <SidebarSectionTabs
        ...
        <SectionsBlock as='div'>
          <WhatSection setAnimatedSectionRef={setAnimatedSectionRef} visibleSections={visibleSections} />
          <HowSection
            setAnimatedSectionRef={setAnimatedSectionRef}
            visibleSections={visibleSections}
