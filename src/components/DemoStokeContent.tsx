...
const DemoStokeCaseStudy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <h1 className="text-4xl font-bold">DemoStoke Case Study</h1>
      <p className="text-xl">Peer-to-Peer Demo Marketplace for Riders: Surf, Snow, SUP, Skate</p>

      <section>
        <h2 className="text-2xl font-semibold">TL;DR (Executive Summary)</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold">Market Research & Competitive Analysis</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold">MVP & UX Strategy</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold">Build Process</h2>
        <ul className="list-disc list-inside space-y-1">
...
export default DemoStokeCaseStudy;
